...
def create_chats(model_id: str = 'gemini-2.5-flash', include_thinking: bool = False, include_search: bool = False, ttl_seconds: str = "300s") -> None:
    ...
    initialization_tasks = [
        ...
        (visual_agent.create_chat_settings, {"model_id": model_id, "ttl_seconds": ttl_seconds}),
        ...
        (safety_agent.create_chat_settings, {'model_id': model_id, 'thinking_included': include_thinking}),
